...
user41 = TestUser.create(name: "Luisa González", location: "Miami", bio: "Exploring the world with a sense of adventure!", gender: "F", preferences: "M", birthday: "1998-12-05", username: "LuisaWorldwide", password_digest:"password1")
...
user43 = TestUser.create(name: "Sofia Patel", location: "Chicago", bio: "Tech enthusiast and bookworm!", gender: "F", preferences: "M", birthday: "1999-07-14", username: "SofiaSilicon", password_digest:"password1")
user44 = TestUser.create(name: "Nabil Ibrahim", location: "San Francisco", bio: "Startup founder and travel lover!", gender: "M", preferences: "F", birthday: "2001-03-30", username: "NabilStartUp", password_digest:"password1")
user45 = TestUser.create(name: "Amara Kim", location: "Los Angeles", bio: "Acting and film aficionado!", gender: "F", preferences: "M", birthday: "2002-09-18", username: "CinemaAmara", password_digest:"password1")
user46 = TestUser.create(name: "Makoto Tanaka", location: "Seattle", bio: "Software engineer and sushi connoisseur!", gender: "M", preferences: "F", birthday: "2003-04-22", username: "CoderMakoto", password_digest:"password1")
user47 = TestUser.create(name: "Elena Vasquez", location: "Denver", bio: "Outdoor explorer and hiker!", gender: "F", preferences: "M", birthday: "2007-08-12", username: "ElenaExplorer", password_digest:"password1")
user48 = TestUser.create(name: "Dimitri Petrov", location: "Boston", bio: "Russian literature and art lover!", gender: "M", preferences: "F", birthday: "1996-06-24", username: "DimitriDostoevsky", password_digest:"password1")
user49 = TestUser.create(name: "Yara Al-Mansoori", location: "Houston", bio: "Fashion designer and Middle Eastern cuisine enthusiast!", gender: "F", preferences: "M", birthday: "2004-01-05", username: "YaraFashion", password_digest:"password1")
...
user52 = TestUser.create(name: "William Kim", location: "Los Angeles", bio: "Tech guru and gaming enthusiast!", gender: "M", preferences: "F", birthday: "2001-05-28", username: "TechWizardKim", password_digest:"password1")
user53 = TestUser.create(name: "Ava Brown", location: "Chicago", bio: "Foodie and culinary adventurer!", gender: "F", preferences: "M", birthday: "1999-02-10", username: "CulinaryAva", password_digest:"password1")
user54 = TestUser.create(name: "Elijah Anderson", location: "Miami", bio: "Beach lover and water sports enthusiast!", gender: "M", preferences: "F", birthday: "2000-04-22", username: "ElijahWaves", password_digest:"password1")
user55 = TestUser.create(name: "Olivia Wilson", location: "San Francisco", bio: "Art and music aficionado!", gender: "F", preferences: "M", birthday: "2002-01-14", username: "ArtisticOlivia", password_digest:"password1")
user56 = TestUser.create(name: "Lucas Smith", location: "Seattle", bio: "Outdoor adventurer and nature lover!", gender: "M", preferences: "F", birthday: "2003-03-30", username: "LucasForester", password_digest:"password1")
user57 = TestUser.create(name: "Sofia Garcia", location: "Phoenix", bio: "Exploring the desert and southwestern cuisine!", gender: "F", preferences: "M", birthday: "2004-09-18", username: "SofiaSand", password_digest:"password1")
user58 = TestUser.create(name: "Alexander Turner", location: "Denver", bio: "Science geek and stargazing enthusiast!", gender: "M", preferences: "F", birthday: "2005-07-05", username: "AstroAlex", password_digest:"password1")
user59 = TestUser.create(name: "Isabella Miller", location: "Boston", bio: "History buff and bookworm!", gender: "F", preferences: "M", birthday: "1999-11-28", username: "IsabellaBookwise", password_digest:"password1")
user60 = TestUser.create(name: "Noah Patel", location: "Austin", bio: "Outdoor sports enthusiast and BBQ lover!", gender: "M", preferences: "F", birthday: "2000-06-24", username: "OutdoorsmanNoah", password_digest:"password1")
