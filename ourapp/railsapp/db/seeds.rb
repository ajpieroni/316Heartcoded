...
UserChat.create(test_user: user1, chat: chat)
UserChat.create(test_user: user2, chat: chat)

Message.create(content: "Hello, Bob!", test_user: user1, chat: chat)
Message.create(content: "Hi, Alice!", test_user: user2, chat: chat)
