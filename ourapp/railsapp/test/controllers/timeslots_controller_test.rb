...
class TimeslotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timeslot" do
    assert_difference("Timeslot.count") do
      post timeslots_url, params: { timeslot: { slot_end: @timeslot.slot_end, slot_start: @timeslot.slot_start } }
    end
  ...
  test "should update timeslot" do
    patch timeslot_url(@timeslot), params: { timeslot: { slot_end: @timeslot.slot_end, slot_start: @timeslot.slot_start } }
